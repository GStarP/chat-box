...
var INPUT_SELECTOR = '[data-chat="chat-input"]';
var LIST_SELECTOR = '[data-chat="chat-list"]';
...
var ChatBox = function ChatBox() {
  ...
  var username = (0, _dom.promptForUsername)();
  ...
  _wsClient2.default.registerOpenHandler(function () {
    _this.chatForm.registerSubmitHandler(function (data) {
      var message = new Message({ content: data, author: username });
      _wsClient2.default.sendMessage(message.serialize());
    });
  });
  _wsClient2.default.registerMessageHandler(function (msg) {
    var message = new Message(msg);
    _this.chatList.renderMessage(message);
  });
};
...
var ChatForm = exports.ChatForm = function () {
  function ChatForm(formSelector, inputSelector) {
    _classCallCheck(this, ChatForm);

    this.$form = (0, _jquery2.default)(formSelector);
    this.$input = (0, _jquery2.default)(inputSelector);
  }

  _createClass(ChatForm, [{
    key: 'registerSubmitHandler',
    value: function registerSubmitHandler(func) {
      var _this = this;
...
var ChatList = exports.ChatList = function () {
  function ChatList(listSelector, username) {
    _classCallCheck(this, ChatList);

    this.$list = (0, _jquery2.default)(listSelector);
    this.username = username;
  }

  _createClass(ChatList, [{
    key: 'renderMessage',
    value: function renderMessage(_ref) {
      var c = _ref.content,
          a = _ref.author,
          t = _ref.time;
